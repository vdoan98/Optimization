...
var resizePizzas = function(size) {
  ...
  arrayLength = document.getElementsByClassName("randomPizzaContainer").length;
...
//the updatePositions function is called on every scroll event so we can says the function is de factor a loop
//when we want to optimize a loop for performance, we want to reduce activity in the looop as much as we can 
